...
![Use Best Practice Adviser in GitHub Copilot App](images/use-best-practice-adviser-copilot-app.png)
...
![Use Best Practice Adviser in VS Code GitHub Copilot Chat](images/use-best-practice-adviser-vscode.png)
